...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "z-50 max-w-xs rounded-lg border border-border bg-card px-3 py-1.5 text-xs text-card-foreground shadow-elevation-3",
...
/**
 * Tooltip simplificado: passa `label` e o gatilho como children.
 * Já inclui Provider para uso pontual sem boilerplate.
 */
